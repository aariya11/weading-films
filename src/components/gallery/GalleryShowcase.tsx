...
export function GalleryShowcase() {
 ...
 return (
 <section
 id="gallery"className="relative py-28 lg:py-44 bg-paper text-ink   border-t border-ink/10 "aria-labelledby="gallery-heading">
 ...
 <h2
 id="gallery-heading"className="font-display text-4xl sm:text-6xl lg:text-8xl tracking-tight leading-[0.95] text-ink ">
 EDITORIAL <br />
 ...
 <div className="pt-2">
 <WhatsAppCTA
 variant="primary"label="Inquire About Your Date (+91 9124885729)"/>
 </div>
 </div>
 </div>
 ...
 className="group cursor-pointer relative bg-paper-warm border border-ink/10 overflow-hidden flex flex-col justify-between transition-all duration-500 hover:shadow-2xl hover:border-champagne/60 hover:-translate-y-1.5"data-cursor="VIEW">
 {/* Image Frame */}
 ...
 alt={item.alt}
 fill
 sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"className="object-cover transition-transform duration-1000 ease-out-expo group-hover:scale-105"/>
 ...
 <div>
 <h3 className="font-display text-base text-ink  group-hover:text-champagne-deep  transition-colors">
 {item.title}
 </h3>
 ...
 <span className="text-xs font-mono text-charcoal/60  group-hover:text-ink  transition-colors">
 ...
 <a
 href="https://wa.me/919124885729"target="_blank"rel="noopener noreferrer"className="inline-flex items-center gap-3 font-mono text-xs tracking-[0.2em] uppercase text-ink  hover:text-champagne-deep  transition-colors underline underline-offset-8 font-semibold">
 ...
 <div
 className="fixed inset-0 z-50 bg-black/95 backdrop-blur-md flex flex-col justify-between p-4 sm:p-8 animate-in fade-in duration-300 touch-manipulation select-none"role="dialog"aria-modal="true"aria-label={activeItem.title}
 ...
 fill
 priority
 sizes="(max-width: 1200px) 100vw, 80vw"className="object-contain"/>
 </div>
 ...
 target="_blank"rel="noopener noreferrer"className="bg-[#25D366] hover:bg-[#20ba59] text-white font-mono text-xs tracking-widest uppercase px-5 py-3 rounded-none font-semibold transition-all inline-flex items-center justify-center gap-2 shadow-lg min-h-[44px] w-full sm:w-auto"
              >
