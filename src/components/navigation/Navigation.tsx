        ...
        <div className="container h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <a
              ...
              className="btn hidden sm:inline-flex items-center gap-1.5 px-3.5 py-2 rounded-full border border-[#1b7a43]/40 !text-[#1b7a43] hover:bg-[#1b7a43] hover:!text-white font-mono text-[11px] tracking-wider uppercase font-bold transition-all duration-200 whitespace-nowrap min-h-[38px]"
            ...
            <Link
              href="/contact"
              className="btn px-4 py-2 sm:px-5 sm:py-2.5 rounded-full bg-ink !text-white font-mono text-[11px] sm:text-xs tracking-[0.2em] uppercase font-bold hover:bg-charcoal hover:!text-white transition-all duration-200 shadow-xs hover:shadow-sm whitespace-nowrap min-h-[38px] flex items-center justify-center"
            >
              INQUIRE
            </Link>
            ...
            >
              ...
              <nav className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-3">
                  <Link
                    href="/contact"
                    className="btn flex items-center justify-center p-3.5 bg-ink !text-white font-mono text-xs tracking-[0.2em] uppercase font-bold hover:bg-charcoal hover:!text-white transition-colors touch-manipulation min-h-[48px] rounded-full shadow-xs"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn flex items-center justify-center gap-2 p-3.5 bg-[#1b7a43] hover:bg-[#156336] !text-white font-mono text-xs tracking-[0.2em] uppercase font-bold transition-all touch-manipulation min-h-[48px] rounded-full shadow-xs"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
